#ifndef SOCIAL_BT_NODES__BT_NODES__INTERACTION__ASK_HPP_
#define SOCIAL_BT_NODES__BT_NODES__INTERACTION__ASK_HPP_
 ...
 */
class Ask : public BT::StatefulActionNode
{
public:
  Ask(
...
#endif  // SOCIAL_BT_NODES__BT_NODES__INTERACTION__ASK_HPP_